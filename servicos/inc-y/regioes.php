<?php if ( $exibirRegioes == false ): ?>
	<h4 class="titulo-regioes-atendimento">Regiões onde a <?=$nomeSite?> atende através do(s) telefone(s): <strong><?php echo $ddd.' '.telefone($telefone); ?></strong> / <strong><?php echo $ddd.' '.telefone($telefone2).''.$whatsapp; ?></strong></h4>
