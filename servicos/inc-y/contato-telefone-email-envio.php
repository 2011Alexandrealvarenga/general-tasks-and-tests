...
if(isset($_POST['submit'])){
    ...
    $telefone_form      = isset($_POST['telefone_form']) && !empty($_POST['telefone_form']) ? utf8_decode($_POST['telefone_form']) : '';
    ...
    $phpmail->AddAddress($emailContato);
        ...
        $phpmail->Body .= "<h2>Contato via LP - $h1</h2>
        ...
        if($send) {
            echo '<div class="mensagem-formulario mensagem-formulario-sucesso">Email Enviado com Sucesso!...</div>';
    ...
    $nome = utf8_encode($nome);
       $telefone_form = utf8_encode($telefone_form);
