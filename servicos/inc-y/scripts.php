...
<script type="application/ld+json">
	{
		...
		"logo": "<?php echo $url.$imagensPadrao.'logo.png'; ?>",
		<?php } elseif(file_exists($imagensPadrao.'logo.jpg')) { ?>
		"logo": "<?php echo $url.$imagensPadrao.'logo.jpg'; ?>",
		<?php } ?>
		...
		<?php } elseif(file_exists($imagensPadrao.'logo.png')) { ?>
		"image": "<?php echo $url.$imagensPadrao.'logo.png'; ?>",
		<?php } elseif(file_exists($imagensPadrao.'logo.jpg')) { ?>
		"image": "<?php echo $url.$imagensPadrao.'logo.jpg'; ?>",
		<?php } ?>
