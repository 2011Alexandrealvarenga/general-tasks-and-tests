<?
$h1           = 'Serviços TOTVS® COMEX'; // Título principal
$description  = 'Serviços TOTVS®: Ajudamos a sua empresa na implantação, suporte, manutenção, alocação de recursos e capacitação da solução. Somos uma empresa especializada em serviços TOTVS® COMEX  Importação, Exportação, Siscomex, Siscoserv, Drawback e integrações.'; // Descrição do serviço/ Palavra
			...
			<div class="conteudo-box">
				<article class="conteudo">
	 				...
	 				*/ ?>
	 				...
	 				<p>Serviços TOTVS®: Ajudamos a sua empresa na implantação, suporte, manutenção, alocação de recursos e capacitação da solução. Somos uma empresa especializada em serviços TOTVS® COMEX  Importação, Exportação, Siscomex, Siscoserv, Drawback e integrações.</p>
	 				...
	 				<p>Experiencia do Usuário (UX):   Como empresa especialista em soluções TOTVS, construímos com a sua empresa, os melhores usos de soluções completas, para o resultado esperado.</p>
